...
extension ColorPalette {
    static let solarized: ColorPalette = .init(
        ...
        groupedBackground: .init(light: base3, dark: base03),
        secondaryGroupedBackground: .init(light: base2, dark: base02),
        ...
        accent: blue,
        neutralAccent: base0,
        colorfulAccents: [orange, violet, blue, green, magenta, cyan, green],
        commentIndentColors: [red, orange, yellow, green, blue, violet]
    )
}
