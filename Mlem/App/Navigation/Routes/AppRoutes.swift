...
extension AppRoute: Equatable, Hashable {
    ...
    func hash(into hasher: inout Hasher) {
        ...
        case let .person(person, communityContext):
        ...
        case let .aboutSettings(value):
            hasher.combine(value)
        case let .appearanceSettings(value):
            hasher.combine(value)
        case let .commentSettings(value):
            hasher.combine(value)
        case let .postSettings(value):
            hasher.combine(value)
        case let .licenseSettings(value):
            hasher.combine(value)
        }
    }
}
