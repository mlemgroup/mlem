...
// class MultiTracker<Item: MultiTrackerItem>: ObservableObject {
//    @Dependency(\.errorHandler) var errorHandler
//
//    @Published var items: [Item.ParentType] = .init()
//
...
//
//    // sub-trackers
//    private var childTrackers: [ChildTracker<Item>]
//
//    init(
//        sortType: Item.SortType,
//        internetSpeed: InternetSpeed,
//        childTrackers: [ChildTracker<Item>]
//    ) {
...
//
//    func addItems(_ newItems: [Item.ParentType]) {
...
//    func reset(with newItems: [Item.ParentType] = .init()) {
...
//        trackerToConsume: ChildTracker<Item>?,
//        trackerToCompare: ChildTracker<Item>
//    ) async -> (Item.SortVal?, ChildTracker<Item>?) {
//        do {
