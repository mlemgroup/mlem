...
struct VotesModel: Hashable {
    ...
    // init from API type
    init(from commentAggregates: APICommentAggregates, myVote: ScoringOperation?) {
        self.upvotes = commentAggregates.upvotes
        self.downvotes = commentAggregates.downvotes
...
extension VotesModel {
    ...
    func applyScoringOperation(operation: ScoringOperation) -> VotesModel {
        ...
        return VotesModel(upvotes: upvotes + upvoteDelta,
