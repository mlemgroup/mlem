...
public actor PostUpdateQueue {
    ...
    func setParent(_ newParent: any Post1Providing) {
        parent = newParent
    ...
    func addItem(item: @escaping () async throws -> any PostSnapshotProviding) {
    ...
    func addItem(item: @escaping (any PostSnapshotProviding) async throws -> any PostSnapshotProviding) {
