...
@Observable
class UnifiedAggregatePostFetcher: UnifiedPostFetcher {
...
public class UnifiedAggregatePostFeedLoader: UnifiedCorePostFeedLoader {
    // force unwrap because this should ALWAYS be an AggregatePostFetcher
    var aggregatePostFetcher: UnifiedAggregatePostFetcher { fetcher as! UnifiedAggregatePostFetcher }
    ...
    public init(
        ...
        super.init(
            ...
            filterContext: filterContext,
            prefetchingConfiguration: prefetchingConfiguration,
            fetcher: UnifiedAggregatePostFetcher(
                api: api,
                feedType: feedType,
                sortType: sortType,
                pageSize: pageSize,
