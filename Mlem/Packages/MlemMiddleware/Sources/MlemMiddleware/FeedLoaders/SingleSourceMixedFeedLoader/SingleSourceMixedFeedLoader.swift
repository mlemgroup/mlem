...
class SingleSourceMixedFetcher: Fetcher<PersonContent> {
    ...
    var postStream: PersonContentStream<UnifiedPostModel>
    ...
    init(
        ...
        userId: Int,
        savedOnly: Bool,
        withContent: (posts: [UnifiedPostModel], comments: [Comment2])?,
...
public class SingleSourceMixedFeedLoader: StandardFeedLoader<PersonContent> {
    ...
    private var postStream: PersonContentStream<UnifiedPostModel> { singleSourceMixedFetcher.postStream }
    ...
    private var tempPostStream: PersonContentStream<UnifiedPostModel>?
    ...
    public init(
        ...
        savedOnly: Bool,
        prefetchingConfiguration: PrefetchingConfiguration,
        withContent: (posts: [UnifiedPostModel], comments: [Comment2])? = nil
    ) {
